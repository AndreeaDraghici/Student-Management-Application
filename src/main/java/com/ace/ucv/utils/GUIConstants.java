...
/*
 * A class containing constants used in the GUI application.
 */
public class GUIConstants {

    /**
     * The name of the GUI application tool.
     */
    ...
    /**
     * The path to the FXML file representing the main view of the GUI application.
     */
