 ...
 */
public interface IDisciplineParser {
     ...
     * @return The loaded configuration as an object of type MateriiType.
     * @throws ConfigurationLoaderException If there is an issue with the configuration loading process.
     */
    MateriiType loadConfiguration(File file) throws ConfigurationLoaderException;
}
