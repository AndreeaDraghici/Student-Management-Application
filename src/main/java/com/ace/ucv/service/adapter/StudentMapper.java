...
public class StudentMapper {
     ...
     */
    public static List<Student> mapStudentiTypeToStudentList(StudentiType studentiType) {
    ...
    private static void getIntermediaryStudentList(List<Student> studentList, StudentType studentType) {
     ...
     */
    public static Student mapStudentTypeToStudent(StudentType studentType) {
